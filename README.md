...
An interactive Jupyter notebook that explains the Comparison Tests. 
...
[![Binder](http://mybinder.org/badge.svg)](http://mybinder.org:/repo/kmcquighan/calc-ii-comparison-tests)

If you download the files to your computer make sure that you have the ComparisonTestTools.py file: these are the backend functions that create the simulations in the notebook.
